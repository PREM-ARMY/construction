				...
				<div class="row">
					<div class="col-md-8">
						<div class="blog-box">
							...
							<div class="blog-post">
								<img src="assets/upload/blog/1.jpg" alt="">
							...
							<div class="blog-post">
								<img src="assets/upload/blog/2.jpg" alt="">
								<div class="post-content-text">
									<ul class="blog_infos nav">
                            <li><a href="#"><i class="fa fa-calendar"></i>19 May, 2015</a></li>
                            <li><a href="#"><i class="fa fa-comment"></i>(3) comments</a></li>
							...
							<div class="blog-post">
								<!-- Vimeo -->
								<iframe src="https://player.vimeo.com/video/97820220" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
							...
							<div class="blog-post">
								<!-- youtube -->
								<iframe class="videoembed" src="https://www.youtube.com/embed/86lwrDp9dio" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" data-devanime="fadeIn" data-devanime-delay="0.6s"></iframe>
								<!-- End youtube -->
								<div class="post-content-text">
									<ul class="blog_infos nav">
                            <li><a href="#"><i class="fa fa-calendar"></i>19 May, 2015</a></li>
						...
						<div class="sidebar">
							...
							<div class="category-widget widget">
								...
								<ul class="category-list">
									<li><a href="#">Ocean Freight <span>18</span></a></li>
									<li><a href="#">Logistics <span>06</span></a></li>
									<li><a href="#">Air Freight <span>12</span></a></li>
									<li><a href="#">Cargo Construct <span>15</span></a></li>
									<li><a href="#">Warehousing <span>6</span></a></li>
									<li><a href="#">Custom Brokerage <span>4</span></a></li>
								</ul>
							</div>
							...
							<div class="tags-widget widget">
								...
								<ul class="tags-list">
									...
									<li><a href="#">Cargo Construct</a></li>
