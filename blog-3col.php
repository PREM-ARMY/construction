		...
		<section class="news-section col3">
			<div class="container">
				<div class="news-box iso-call">
					...
					<div class="news-post">
						<img src="assets/upload/others/ser1.jpg" alt="">
						<div class="post-content-text">
                            ...
                            <li><a href="#"><i class="fa fa-comment"></i>(3) comments</a></li>
									...
									<h2><a href="single-post.html">Blog Title Here</a></h2>
					...
					<div class="news-post">
						<img src="assets/upload/others/ser2.jpg" alt="">
						<div class="post-content-text">
									<ul class="blog_infos nav">
                            <li><a href="#"><i class="fa fa-calendar"></i>19 May, 2015</a></li>
                            <li><a href="#"><i class="fa fa-comment"></i>(3) comments</a></li>
					...
					<div class="news-post">
						<img src="assets/upload/others/ser4.jpg" alt="">
						<div class="post-content-text">
									<ul class="blog_infos nav">
                            <li><a href="#"><i class="fa fa-calendar"></i>19 May, 2015</a></li>
                            <li><a href="#"><i class="fa fa-comment"></i>(3) comments</a></li>
